            ...
            <div class="col-xs-8">
                <div class="user-menu">
                    <ul>
                        ...
                        <li><a href="${base}/phoneView"><i class="fa fa-phone"></i> 手机浏览</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xs-4">
    ...
    <div class="container_self">
        <div class="row" style="padding-top: 15px;">
            ...
            <div class="col-xs-4">
                <div class="row">
                    <div class="col-xs-6">
                        <img src="${base}/img/kfmm.png" style="width: 120px;height: 120px" alt="扫码访问手机版">
                        <p style="padding-left: 15px;color: #aaa;font-size: 10px">扫码访问手机版</p>
                    </div>
                    <div class="col-xs-6">
                        <img src="${base}/img/gongzhonghao.png" style="width: 120px;height: 120px" alt="公众号">
                        <p style="padding-left: 15px;color: #aaa;font-size: 10px">扫码访问公众号</p>
                    </div>
                </div>
...
<script>
    $(function () {
        $("body").floating({"theme":"panel_theme_round_solid",
            ...
            "account":[
                {"type":"Viber","tip":"0371-23253932","text":null,"url":null},
                {"type":"Phone","tip":"http://www.kfmm.com.cn/img/kfmm.png","text":null,"url":null},
