    ...
    <div class="container_self">
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="table-title">贴片广告 |  投放请联系：xxxxxxxxxx XX）<strong> 由于网站正在建设,以下费用均为虚假展示所用,如想办理相关业务,请 <a href="${base}/abcout/contact" style="color: #ff552e;">联系</a> !</strong></p>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="table-title">招聘置顶 |  投放请联系：xxxxxxxxxx XX）<strong> 由于网站正在建设,以下费用均为虚假展示所用,如想办理相关业务,请 <a href="${base}/abcout/contact" style="color: #ff552e;">联系</a> !</strong></p>
            </div>
            <div class="panel-body">
                <table class="table">
                    <tr>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="table-title">竞价排名 |  投放请联系：xxxxxxxxxx XX）<strong> 由于网站正在建设,以下费用均为虚假展示所用,如想办理相关业务,请 <a href="${base}/abcout/contact" style="color: #ff552e;">联系</a> !</strong></p>
            </div>
            <div class="panel-body">
                <table class="table">
                    <tr>
